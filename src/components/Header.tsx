          ...
          {user && (
            <div className="flex items-center gap-1.5 md:gap-2 ml-1 md:ml-2 pl-1 md:pl-2 border-l border-border">
              ...
              <form action={cerrarSesion}>
                <button
                  type="submit"
                  className="text-xs text-text-secondary hover:text-danger transition cursor-pointer font-medium flex items-center gap-1"
                  title="Cerrar sesión"
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="md:mr-0">
